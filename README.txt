...
Starting with Version 1.4, the memory requirements exceeded the Teensy 3.2, and either a Teensy 3.5/3.6 must be used. The devices are pin-for-pin compatable, however the 3.5 and 3.6 are both physically longer with additional pins. A re-spin of the PC board will include the new footprint. This project is NOT electrically compatible with Teensy 4.0, but the software is. Change the #define in hardware.h to select your device.
